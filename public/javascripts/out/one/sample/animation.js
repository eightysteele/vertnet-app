...
var content__15240 = domina.xpath.xpath.call(null,"//div[@id='content']");

domina.destroy_children_BANG_.call(null,content__15240);
domina.set_html_BANG_.call(null,content__15240,form_html);
domina.append_BANG_.call(null,content__15240,greeting_html);
...
return one.browser.animation.play.call(null,label,cljs.core.ObjMap.fromObject(["﷐'effect","﷐'start","﷐'end","﷐'time"],{"﷐'effect":"﷐'fade","﷐'start":1,"﷐'end":0,"﷐'time":200}));
});
...
one.sample.animation.fade_out = cljs.core.ObjMap.fromObject(["﷐'effect","﷐'start","﷐'end","﷐'time"],{"﷐'effect":"﷐'fade","﷐'start":1,"﷐'end":0,"﷐'time":400});
/**
...
var e__15241 = cljs.core.ObjMap.fromObject(["﷐'effect","﷐'start","﷐'end","﷐'time"],{"﷐'effect":"﷐'fade","﷐'start":1,"﷐'end":0,"﷐'time":500});

return one.browser.animation.play_animation.call(null,one.browser.animation.parallel.call(null,one.browser.animation.bind.call(null,one.sample.animation.form,e__15241),one.browser.animation.bind.call(null,one.sample.animation.label,e__15241),one.browser.animation.bind.call(null,one.sample.animation.cloud,cljs.core.ObjMap.fromObject(["﷐'effect","﷐'time"],{"﷐'effect":"﷐'color","﷐'time":500}),cljs.core.ObjMap.fromObject(["﷐'effect","﷐'time"],{"﷐'effect":"﷐'fade-in-and-show","﷐'time":600}))),cljs.core.ObjMap.fromObject(["﷐'before","﷐'after"],{"﷐'before":(function (){
...
var button__15242 = domina.by_id.call(null,id);

goog.dom.forms.setDisabled.call(null,button__15242,true);
return one.browser.animation.play.call(null,button__15242,cljs.core.ObjMap.fromObject(["﷐'effect","﷐'end","﷐'time"],{"﷐'effect":"﷐'fade","﷐'end":0.2,"﷐'time":400}));
});
/**
...
var button__15243 = domina.by_id.call(null,id);

goog.dom.forms.setDisabled.call(null,button__15243,false);
return one.browser.animation.play.call(null,button__15243,one.sample.animation.fade_in);
});
