...
var content__12712 = domina.xpath.xpath.call(null,"//div[@id='content']");

domina.destroy_children_BANG_.call(null,content__12712);
domina.set_html_BANG_.call(null,content__12712,form_html);
domina.append_BANG_.call(null,content__12712,greeting_html);
...
var e__12713 = cljs.core.ObjMap.fromObject(["﷐'effect","﷐'start","﷐'end","﷐'time"],{"﷐'effect":"﷐'fade","﷐'start":1,"﷐'end":0,"﷐'time":500});

return one.browser.animation.play_animation.call(null,one.browser.animation.parallel.call(null,one.browser.animation.bind.call(null,one.sample.animation.form,e__12713),one.browser.animation.bind.call(null,one.sample.animation.label,e__12713),one.browser.animation.bind.call(null,one.sample.animation.cloud,cljs.core.ObjMap.fromObject(["﷐'effect","﷐'time"],{"﷐'effect":"﷐'color","﷐'time":500}),cljs.core.ObjMap.fromObject(["﷐'effect","﷐'time"],{"﷐'effect":"﷐'fade-in-and-show","﷐'time":600}))),cljs.core.ObjMap.fromObject(["﷐'before","﷐'after"],{"﷐'before":(function (){
...
var button__12714 = domina.by_id.call(null,id);

goog.dom.forms.setDisabled.call(null,button__12714,true);
return one.browser.animation.play.call(null,button__12714,cljs.core.ObjMap.fromObject(["﷐'effect","﷐'end","﷐'time"],{"﷐'effect":"﷐'fade","﷐'end":0.2,"﷐'time":400}));
});
/**
...
var button__12715 = domina.by_id.call(null,id);

goog.dom.forms.setDisabled.call(null,button__12715,false);
return one.browser.animation.play.call(null,button__12715,one.sample.animation.fade_in);
});
